...
var FullCalendar = (function (e) {
            ...
            e: if ("function" == typeof T) {
                if (
                    ...
                    null != h.componentWillUpdate &&
                        h.componentWillUpdate(E, h.__s, D),
    ...
    function N(e, t, r) {
        ...
        if (
            ...
            (i = e.ref) &&
                ((i.current && i.current !== e.__e) || O(i, null, t)),
            null != (i = e.__c))
        ) {
    ...
    (n.unmount = function (e) {
        ...
        (re.prototype.render = function (e, t) {
            ...
            return (
                i && (i.__h = null), [f(m, null, t.__a ? null : e.children), i]
            );
        });
    ...
    function Ke(e, t, n) {
        return n.func
            ? n.func(e, t)
            : et(e[n.field], t[n.field]) * (n.order || 1);
    }
    function et(e, t) {
        return e || t
            ? null == t
            ...
            (function (e) {
                ...
                t =
                    !0 === e
                        ...
                        : [];
                return (
                    (t = t.map((e) => Object.assign(Object.assign({}, Ur), e))),
                    t
                );
            })(e),
            null,
    ...
    class Pi {
        ...
        splitProps(e) {
            let t = this.getKeyInfo(e),
                ...
                l = {};
            this.eventUiBuilders = vn(
                t,
                (e, t) => this.eventUiBuilders[t] || Ut(Hi)
            );
            for (let n in t) {
                let c = t[n],
                    d = s[n] || Ni,
        ...
        updateSize() {
            ...
            if (i) {
                let s = r.getBoundingClientRect(),
                    o = n
                        ? _e(t, ".fc-scrollgrid").getBoundingClientRect().top
                        : i.top,
    ...
    class po extends Un {
        ...
        updateParentEl() {
            this.linkEl &&
                (this.parentEl = _e(this.linkEl, ".fc-view-harness"));
        }
    }
    function mo(e) {
        return e.text;
    ...
    function vo(e) {
        if (e.allDayDate)
            return { start: e.allDayDate, end: bt(e.allDayDate, 1) };
        let { hiddenSegs: t } = e;
        return {
            start: yo(t),
            ...
            (e) =>
                (function (e, t, n, r, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            d(i) || e.defaults.buttonText || d(rn) || e.type,
                        buttonTitleOverride:
                            u(r) || u(n) || e.overrides.buttonHint,
                        buttonTitleDefault:
                            u(i) || e.defaults.buttonHint || u(rn),
                    };
                })(e, s, t, n, r)
        );
    }
    ...
    function zo(e, t, n, r) {
        ...
        switch (t.type) {
            ...
            case "REMOVE_EVENT_SOURCE":
                return (
                    (s = e), (o = t.sourceId), mn(s, (e) => e.sourceId !== o)
                );
            case "PREV":
            case "NEXT":
            case "CHANGE_DATE":
        ...
        processRawCalendarOptions(e, t) {
            let { locales: n, locale: r } = un([rn, e, t]),
                ...
                l = (this.currentCalendarOptionsRefiners = Object.assign(
                    Object.assign(
                        Object.assign(
                            Object.assign(Object.assign({}, nn), sn),
                            on
                        ),
                        a.listenerRefiners
                    ),
            ...
            for (let e in s)
                s[e] === l[e] || (an[e] && an[e](s[e], l[e]))
                    ...
                    : (s[e] === this.currentCalendarOptionsInput[e] ||
                      (an[e] &&
                          an[e](s[e], this.currentCalendarOptionsInput[e]))
    ...
    function wa(e) {
        ...
        return new Mn(
            Object.assign(
                Object.assign(
                    { timeZone: rn.timeZone, calendarSystem: "gregory" },
                    e
                ),
                { locale: t }
            )
        ...
        constructor(e) {
            super(e),
                ...
                (this.handlePointerDown = (e) => {
                    ...
                    let c =
                        n.isValidSegDownEl(t) && !_e(t, ".fc-event-resizer");
                    r.setIgnoreMove(!c),
                        (this.isDragging =
                            c &&
            ...
            if (this.needsScrollReset && this.props.clientWidth) {
                const e = (function (e, t) {
                    ...
                    t.currentRangeUnit.match(/year|month/) &&
                        (n = e.querySelector(
                            `[data-date="${Bt(t.currentDate)}-01"]`
                        ));
                    n ||
                        (n = e.querySelector(
                            `[data-date="${Ht(t.currentDate)}"]`
                        ));
                    return n;
    ...
    class Tl {
        ...
        computeTimeTop(e) {
            let t,
                ...
                s = r.els.length,
                o =
                    (e.milliseconds - ft(i.slotMinTime)) /
                    ft(this.slotDuration);
            return (
                (o = Math.max(0, o)),
                (o = Math.min(s, o)),
                (t = Math.floor(o)),
